...
public final class RequestOustPledgeMember extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		clan.removeClanMember(member.getObjectId(), System.currentTimeMillis() + ConfigClans.CLAN_JOIN_DAYS * 86400000L);
		clan.setCharPenaltyExpiryTime(System.currentTimeMillis() + ConfigClans.CLAN_JOIN_DAYS * 86400000L);
		clan.updateClanInDB();
