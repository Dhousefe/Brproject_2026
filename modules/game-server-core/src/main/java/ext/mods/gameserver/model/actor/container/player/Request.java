...
public class Request
{
	...
	private volatile ScheduledFuture<?> _requestTimer;
	...
	public synchronized boolean setSiteRequest(L2GameClientPacket packet)
	{
		if (isProcessingRequest())
			return false;
	 ...
	 */
	public synchronized void onRequestResponse()
	{
