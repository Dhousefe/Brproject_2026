...
public class Intention implements Comparable<Intention>
{
	...
	@Override
	public synchronized int compareTo(Intention other)
	{
		if (!equals(other))
			return -1;
	...
	public synchronized IntentionType getType()
	{
		return _type;
	}

	public synchronized WorldObject getTarget()
	{
		return _target;
	}

	public synchronized Creature getFinalTarget()
	{
		return _finalTarget;
	}

	public synchronized L2Skill getSkill()
	{
		return _skill;
	}

	public synchronized Location getLoc()
	{
		return _loc;
	}
	...
	public synchronized int getItemObjectId()
	{
		return _itemObjectId;
	}

	public synchronized String getRouteName()
	{
		return _routeName;
	}
	...
	public synchronized boolean canMoveToTarget()
	{
