...
public class ChatShout implements IChatHandler
{
	...
	public void handleChat(SayType type, Player player, String target, String text)
	{
		...
		if (ConfigProject.GLOBAL_CHAT.equalsIgnoreCase("global") || (ConfigProject.GLOBAL_CHAT.equalsIgnoreCase("gm") && player.isGM()))
		{
		...
		else if (ConfigProject.GLOBAL_CHAT.equalsIgnoreCase("on"))
