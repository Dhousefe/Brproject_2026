...
public final class RequestPetitionCancel extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		player.sendPacket(SystemMessage.getSystemMessage(SystemMessageId.PETITION_CANCELED_SUBMIT_S1_MORE_TODAY).addNumber(ConfigPlayers.MAX_PETITIONS_PER_PLAYER - PetitionManager.getInstance().getPetitionsCount(player)));
