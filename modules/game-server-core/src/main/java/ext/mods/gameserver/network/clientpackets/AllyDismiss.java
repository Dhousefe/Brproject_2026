...
public final class AllyDismiss extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		leaderClan.setAllyPenaltyExpiryTime(currentTime + ConfigClans.ACCEPT_CLAN_DAYS_WHEN_DISMISSED * 86400000L, Clan.PENALTY_TYPE_DISMISS_CLAN);
		leaderClan.updateClanInDB();
		
		clan.setAllyId(0);
		clan.setAllyName(null);
		clan.changeAllyCrest(0, true);
		clan.setAllyPenaltyExpiryTime(currentTime + ConfigClans.ALLY_JOIN_DAYS_WHEN_DISMISSED * 86400000L, Clan.PENALTY_TYPE_CLAN_DISMISSED);
		clan.updateClanInDB();
