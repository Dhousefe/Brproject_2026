...
public class FuncEnchant extends Func
{
	...
	public double calc(Creature effector, Creature effected, L2Skill skill, double base, double value)
	{
		...
		{
			if (player.isInOlympiadMode() && ConfigEvents.OLY_ENCHANT_LIMIT >= 0 && (enchant + overenchant) > ConfigEvents.OLY_ENCHANT_LIMIT)
			{
				if (ConfigEvents.OLY_ENCHANT_LIMIT > 3)
					overenchant = ConfigEvents.OLY_ENCHANT_LIMIT - 3;
				else
				{
					overenchant = 0;
					enchant = ConfigEvents.OLY_ENCHANT_LIMIT;
				}
			}
		}
