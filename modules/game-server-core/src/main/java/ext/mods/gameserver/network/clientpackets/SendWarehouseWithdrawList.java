...
public final class SendWarehouseWithdrawList extends L2GameClientPacket
{
	...
	protected void readImpl()
	{
		...
		if (count <= 0 || count > ConfigPlayers.MAX_ITEM_IN_PACKET || count * BATCH_LENGTH != _buf.remaining())
			return;
	...
	protected void runImpl()
	{
		...
		if (!ConfigPlayers.KARMA_PLAYER_CAN_USE_WH && player.getKarma() > 0)
			return;
		
		if (ConfigClans.MEMBERS_CAN_WITHDRAW_FROM_CLANWH)
		{
