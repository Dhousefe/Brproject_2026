...
public class CofferOfShadows extends Events
{
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		{
			if ((player.getInventory().getItemCount(ConfigEvents.COFFER_PRICE_ID) >= ConfigEvents.COFFER_PRICE_AMOUNT))
			{
				takeItems(player, ConfigEvents.COFFER_PRICE_ID, ConfigEvents.COFFER_PRICE_AMOUNT);
		...
		{
			if ((player.getInventory().getItemCount(ConfigEvents.COFFER_PRICE_ID) >= (ConfigEvents.COFFER_PRICE_AMOUNT * 5)))
			{
				takeItems(player, ConfigEvents.COFFER_PRICE_ID, ConfigEvents.COFFER_PRICE_AMOUNT * 5);
		...
		{
			if ((player.getInventory().getItemCount(ConfigEvents.COFFER_PRICE_ID) >= (ConfigEvents.COFFER_PRICE_AMOUNT * 10)))
			{
				takeItems(player, ConfigEvents.COFFER_PRICE_ID, ConfigEvents.COFFER_PRICE_AMOUNT * 10);
		...
		{
			if ((player.getInventory().getItemCount(ConfigEvents.COFFER_PRICE_ID) >= (ConfigEvents.COFFER_PRICE_AMOUNT * 50)))
			{
				takeItems(player, ConfigEvents.COFFER_PRICE_ID, ConfigEvents.COFFER_PRICE_AMOUNT * 50);
