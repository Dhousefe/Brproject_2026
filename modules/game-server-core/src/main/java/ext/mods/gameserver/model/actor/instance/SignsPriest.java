...
public class SignsPriest extends Folk
{
		...
		else if (command.startsWith("SevenSigns"))
		{
			...
			switch (value)
			{
				...
				case 33:
					...
					if (!ConfigEvents.SEVEN_SIGNS_BYPASS_PREREQUISITES)
					{
				...
				case 6:
					...
					if (contribScore == ConfigEvents.MAXIMUM_PLAYER_CONTRIB)
					...
					else
					{
						...
						switch (stoneType)
						{
							...
							case 4:
								...
								int redContribCount = (ConfigEvents.MAXIMUM_PLAYER_CONTRIB - tempContribScore) / SevenSignsManager.SEAL_STONE_RED_VALUE;
								...
								int greenContribCount = (ConfigEvents.MAXIMUM_PLAYER_CONTRIB - tempContribScore) / SevenSignsManager.SEAL_STONE_GREEN_VALUE;
								...
								int blueContribCount = (ConfigEvents.MAXIMUM_PLAYER_CONTRIB - tempContribScore) / SevenSignsManager.SEAL_STONE_BLUE_VALUE;
				...
				case 21:
					...
					{
						case SevenSignsManager.SEAL_STONE_BLUE_ID:
							maxStoneCountToContribute = (ConfigEvents.MAXIMUM_PLAYER_CONTRIB - score) / SevenSignsManager.SEAL_STONE_BLUE_VALUE;
							break;
						
						case SevenSignsManager.SEAL_STONE_GREEN_ID:
							maxStoneCountToContribute = (ConfigEvents.MAXIMUM_PLAYER_CONTRIB - score) / SevenSignsManager.SEAL_STONE_GREEN_VALUE;
							break;
						
						case SevenSignsManager.SEAL_STONE_RED_ID:
							maxStoneCountToContribute = (ConfigEvents.MAXIMUM_PLAYER_CONTRIB - score) / SevenSignsManager.SEAL_STONE_RED_VALUE;
							break;
					}
	...
	public void showChatWindow(Player player, int val)
	{
		...
		switch (npcId)
		{
			...
			case 31113:
				if (ConfigProject.STRICT_SEVENSIGNS)
				{
