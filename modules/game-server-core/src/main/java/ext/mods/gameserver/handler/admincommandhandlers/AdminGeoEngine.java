			...
			try
			{
				switch (st.nextToken())
				{
					...
					case "see":
						...
						oh = (oh * ConfigGeoengine.PART_OF_CHARACTER_HEIGHT) / 100;
						...
						th = (th * ConfigGeoengine.PART_OF_CHARACTER_HEIGHT) / 100;
						...
						debug.addLine("Geodata limit", Color.MAGENTA, true, ox, oy, oh + ConfigGeoengine.MAX_OBSTACLE_HEIGHT, tx, ty, th + ConfigGeoengine.MAX_OBSTACLE_HEIGHT);
						debug.sendTo(player);
						break;
