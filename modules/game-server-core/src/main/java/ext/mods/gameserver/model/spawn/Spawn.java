...
public final class Spawn extends ASpawn
{
	...
	public boolean isInMyTerritory(WorldObject worldObject)
	{
		...
		return worldObject.isIn3DRadius(_loc, ConfigNpcs.MAX_DRIFT_RANGE);
	}
	...
	{
		final int biasedZ = loc.getZ() - ConfigGeoengine.NPC_Z_INDEX;
	...
	{
		_loc.set(x, y, GeoEngine.getInstance().getHeight(x, y, z - ConfigGeoengine.NPC_Z_INDEX), heading);
	}
