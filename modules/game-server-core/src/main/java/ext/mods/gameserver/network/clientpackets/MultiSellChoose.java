...
public class MultiSellChoose extends L2GameClientPacket
{
	...
	public void runImpl()
	{
		...
		if (_amount < 1 || _amount > ConfigProject.MULTISELL_MAX_AMOUNT)
		{
			player.setMultiSell(null);
			return;
		}
		...
		final boolean isCb = list instanceof CommunityBoardListContainer;
		final Folk folk = isCb ? null : player.getCurrentFolk();
		if (!isCb)
		{
