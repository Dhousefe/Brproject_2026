...
public class RandomZone extends SpawnZoneType
{
	...
	protected void onEnter(Creature character)
	{
		...
		if (character instanceof Player)
		{
			...
			final IFarmZoneInfo zoneData = FarmEventHooks.get().getZoneDataForZone(this);
			...
			if (_flagzone)
			{
				...
				PvpFlagTaskManager.getInstance().add(player, ConfigPlayers.PVP_NORMAL_TIME);
			}
	...
	protected void onExit(Creature character)
	{
		...
		if (character instanceof Player)
		{
			...
			final IFarmZoneInfo exitZoneData = FarmEventHooks.get().getZoneDataForZone(this);
			if (exitZoneData != null && exitZoneData.isEnchanterZone())
			{
				PvpFlagTaskManager.getInstance().add(player, ConfigPlayers.PVP_NORMAL_TIME);
			}
