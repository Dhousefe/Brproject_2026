...
public abstract class AbstractNpcInfo extends L2GameServerPacket
{
		...
		protected void writeImpl()
		{
			...
			else
			{
				...
				if (ConfigNpcs.CHAMPION_FREQUENCY > 0)
					writeC(_npc.isChampion() ? ConfigNpcs.CHAMPION_AURA : 0);
				else
					writeC(0x00);
	...
	public static class SummonInfo extends AbstractNpcInfo
	{
		...
		public SummonInfo(Summon summon, Player attacker, int val)
		{
			...
			if (ConfigNpcs.SHOW_SUMMON_CREST && _owner != null && _owner.getClan() != null)
			{
