...
public class SummonCreature implements ISkillHandler
{
	...
	public void useSkill(Creature creature, L2Skill skill, WorldObject[] targets, ItemInstance item)
	{
		...
		List<? extends IAgathionSpec> agathionList = AgathionHooks.get().getAgathionsByItemId(checkedItem.getItemId());
		...
		spawnLoc.addStrictOffset(ConfigNpcs.SUMMON_DRIFT_RANGE);
		...
		if (isAgathion)
		{
			...
			AgathionState.set(player, agathion);
