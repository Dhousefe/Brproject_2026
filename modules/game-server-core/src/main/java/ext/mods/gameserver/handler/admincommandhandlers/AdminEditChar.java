...
public class AdminEditChar implements IAdminCommandHandler
{
	...
	public static void gatherPlayerInfo(Player player, Player targetPlayer, NpcHtmlMessage html)
	{
		...
		html.replace("%ip%", (targetPlayer.getClient() == null || targetPlayer.getClient().isDetached()) ? "Offline trader" : ConfigLogin.PROXY ? targetPlayer.getClient().getRealIpAddress() : targetPlayer.getClient().getIpAddress());
	}
