...
public final class RequestPackageSend extends L2GameClientPacket
{
	...
	protected void readImpl()
	{
		...
		int count = readD();
		if (count < 0 || count > ConfigPlayers.MAX_ITEM_IN_PACKET)
			return;
	...
	{
		if (_items == null || _items.isEmpty() || !ConfigServer.ALLOW_FREIGHT)
			return;
		...
		int fee = _items.size() * ConfigPlayers.FREIGHT_PRICE;
