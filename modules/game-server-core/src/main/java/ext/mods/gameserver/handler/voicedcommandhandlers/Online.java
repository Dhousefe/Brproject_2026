...
public class Online implements IVoicedCommandHandler
{
	...
	{
		if (command.equals("online") && ConfigProject.ENABLE_ONLINE_COMMAND)
			player.sendMessage(player.getSysString(10_088, World.getInstance().getPlayers().size() * ConfigProject.MULTIPLIER_ONLINE_COMMAND));
		else
