	...
	public void onBypassFeedback(Player player, String command)
	{
			...
			if (val.equalsIgnoreCase("recovery"))
			{
				if (st.hasMoreTokens())
				{
					...
					else if (val.equalsIgnoreCase("edit_hp"))
					{
						...
						{
							case 80:
								cost = ConfigClans.CS_HPREG1_FEE;
								break;
							case 120:
								cost = ConfigClans.CS_HPREG2_FEE;
								break;
							case 180:
								cost = ConfigClans.CS_HPREG3_FEE;
								break;
							case 240:
								cost = ConfigClans.CS_HPREG4_FEE;
								break;
							default:
								cost = ConfigClans.CS_HPREG5_FEE;
								break;
						}
						
						html.replace("%cost%", cost + "</font> adenas / " + (ConfigClans.CS_HPREG_FEE_RATIO / 86400000) + " day</font>)");
					...
					else if (val.equalsIgnoreCase("edit_mp"))
					{
						...
						{
							case 5:
								cost = ConfigClans.CS_MPREG1_FEE;
								break;
							case 15:
								cost = ConfigClans.CS_MPREG2_FEE;
								break;
							case 30:
								cost = ConfigClans.CS_MPREG3_FEE;
								break;
							default:
								cost = ConfigClans.CS_MPREG4_FEE;
								break;
						}
						html.replace("%cost%", cost + "</font> adenas / " + (ConfigClans.CS_MPREG_FEE_RATIO / 86400000) + " day</font>)");
					...
					else if (val.equalsIgnoreCase("edit_exp"))
					{
						...
						{
							case 15:
								cost = ConfigClans.CS_EXPREG1_FEE;
								break;
							case 25:
								cost = ConfigClans.CS_EXPREG2_FEE;
								break;
							case 35:
								cost = ConfigClans.CS_EXPREG3_FEE;
								break;
							default:
								cost = ConfigClans.CS_EXPREG4_FEE;
								break;
						}
						html.replace("%cost%", cost + "</font> adenas / " + (ConfigClans.CS_EXPREG_FEE_RATIO / 86400000) + " day</font>)");
					...
					else if (val.equalsIgnoreCase("hp"))
					{
						...
						switch (percent)
						{
							case 0:
								...
								break;
							case 80:
								fee = ConfigClans.CS_HPREG1_FEE;
								break;
							case 120:
								fee = ConfigClans.CS_HPREG2_FEE;
								break;
							case 180:
								fee = ConfigClans.CS_HPREG3_FEE;
								break;
							case 240:
								fee = ConfigClans.CS_HPREG4_FEE;
								break;
							default:
								fee = ConfigClans.CS_HPREG5_FEE;
								break;
						}
						
						if (!getCastle().updateFunctions(player, Castle.FUNC_RESTORE_HP, percent, fee, ConfigClans.CS_HPREG_FEE_RATIO, (getCastle().getFunction(Castle.FUNC_RESTORE_HP) == null)))
					...
					else if (val.equalsIgnoreCase("mp"))
					{
						...
						switch (percent)
						{
							case 0:
								...
								break;
							case 5:
								fee = ConfigClans.CS_MPREG1_FEE;
								break;
							case 15:
								fee = ConfigClans.CS_MPREG2_FEE;
								break;
							case 30:
								fee = ConfigClans.CS_MPREG3_FEE;
								break;
							default:
								fee = ConfigClans.CS_MPREG4_FEE;
								break;
						}
						if (!getCastle().updateFunctions(player, Castle.FUNC_RESTORE_MP, percent, fee, ConfigClans.CS_MPREG_FEE_RATIO, (getCastle().getFunction(Castle.FUNC_RESTORE_MP) == null)))
							html.setFile(player.getLocale(), "html/chamberlain/low_adena.htm");
					...
					else if (val.equalsIgnoreCase("exp"))
					{
						...
						switch (percent)
						{
							case 0:
								...
								break;
							case 15:
								fee = ConfigClans.CS_EXPREG1_FEE;
								break;
							case 25:
								fee = ConfigClans.CS_EXPREG2_FEE;
								break;
							case 35:
								fee = ConfigClans.CS_EXPREG3_FEE;
								break;
							default:
								fee = ConfigClans.CS_EXPREG4_FEE;
								break;
						}
						if (!getCastle().updateFunctions(player, Castle.FUNC_RESTORE_EXP, percent, fee, ConfigClans.CS_EXPREG_FEE_RATIO, (getCastle().getFunction(Castle.FUNC_RESTORE_EXP) == null)))
							html.setFile(player.getLocale(), "html/chamberlain/low_adena.htm");
				...
				else
				{
					...
					if (chfHp != null)
					{
						html.replace("%hp_recovery%", chfHp.getLvl() + "%</font> (<font color=\"FFAABB\">" + chfHp.getLease() + "</font> adenas /" + ConfigClans.CS_HPREG_FEE_RATIO / 86400000 + " day");
					...
					if (chfExp != null)
					{
						html.replace("%exp_recovery%", chfExp.getLvl() + "%</font> (<font color=\"FFAABB\">" + chfExp.getLease() + "</font> adenas /" + ConfigClans.CS_EXPREG_FEE_RATIO / 86400000 + " day)");
					...
					if (chfMp != null)
					{
						html.replace("%mp_recovery%", chfMp.getLvl() + "%</font> (<font color=\"FFAABB\">" + chfMp.getLease() + "</font> adenas /" + ConfigClans.CS_MPREG_FEE_RATIO / 86400000 + " day)");
			...
			else if (val.equalsIgnoreCase("other"))
			{
				if (st.hasMoreTokens())
				{
					...
					else if (val.equalsIgnoreCase("edit_support"))
					{
						...
						{
							case 1:
								cost = ConfigClans.CS_SUPPORT1_FEE;
								break;
							case 2:
								cost = ConfigClans.CS_SUPPORT2_FEE;
								break;
							case 3:
								cost = ConfigClans.CS_SUPPORT3_FEE;
								break;
							default:
								cost = ConfigClans.CS_SUPPORT4_FEE;
								break;
						}
						html.replace("%cost%", cost + "</font> adenas / " + (ConfigClans.CS_SUPPORT_FEE_RATIO / 86400000) + " day</font>)");
					...
					else if (val.equalsIgnoreCase("edit_tele"))
					{
						...
						{
							case 1:
								cost = ConfigClans.CS_TELE1_FEE;
								break;
							default:
								cost = ConfigClans.CS_TELE2_FEE;
								break;
						}
						
						html.replace("%cost%", cost + "</font> adenas / " + (ConfigClans.CS_TELE_FEE_RATIO / 86400000) + " day</font>)");
					...
					else if (val.equalsIgnoreCase("tele"))
					{
						...
						switch (lvl)
						{
							case 0:
								...
								break;
							case 1:
								fee = ConfigClans.CS_TELE1_FEE;
								break;
							default:
								fee = ConfigClans.CS_TELE2_FEE;
								break;
						}
						if (!getCastle().updateFunctions(player, Castle.FUNC_TELEPORT, lvl, fee, ConfigClans.CS_TELE_FEE_RATIO, (getCastle().getFunction(Castle.FUNC_TELEPORT) == null)))
							html.setFile(player.getLocale(), "html/chamberlain/low_adena.htm");
					...
					else if (val.equalsIgnoreCase("support"))
					{
						...
						switch (lvl)
						{
							case 0:
								...
								break;
							case 1:
								fee = ConfigClans.CS_SUPPORT1_FEE;
								break;
							case 2:
								fee = ConfigClans.CS_SUPPORT2_FEE;
								break;
							case 3:
								fee = ConfigClans.CS_SUPPORT3_FEE;
								break;
							default:
								fee = ConfigClans.CS_SUPPORT4_FEE;
								break;
						}
						if (!getCastle().updateFunctions(player, Castle.FUNC_SUPPORT, lvl, fee, ConfigClans.CS_SUPPORT_FEE_RATIO, (chf == null)))
							html.setFile(player.getLocale(), "html/chamberlain/low_adena.htm");
				...
				else
				{
					...
					if (chfTel != null)
					{
						html.replace("%tele%", "Stage " + chfTel.getLvl() + "</font> (<font color=\"FFAABB\">" + chfTel.getLease() + "</font> adenas /" + ConfigClans.CS_TELE_FEE_RATIO / 86400000 + " day)");
					...
					if (chfSup != null)
					{
						html.replace("%support%", "Stage " + chfSup.getLvl() + "</font> (<font color=\"FFAABB\">" + chfSup.getLease() + "</font> adenas /" + ConfigClans.CS_SUPPORT_FEE_RATIO / 86400000 + " Day)");
		...
		else if (actualCommand.equalsIgnoreCase("support"))
		{
			...
			try
			{
				...
				if (ConfigProject.CUSTOM_BUFFER_MANAGER_NPC)
				{
