...
public class NpcTemplate extends CreatureTemplate
{
	...
	public NpcTemplate(StatSet set)
	{
		...
		if (ConfigNpcs.NPC_STAT_MULTIPLIERS)
		{
			switch (_type)
			{
				case "Monster":
					_baseHpMax *= ConfigNpcs.MONSTER_HP_MULTIPLIER;
					_baseMpMax *= ConfigNpcs.MONSTER_MP_MULTIPLIER;
					_basePAtk *= ConfigNpcs.MONSTER_PATK_MULTIPLIER;
					_baseMAtk *= ConfigNpcs.MONSTER_MATK_MULTIPLIER;
					_basePDef *= ConfigNpcs.MONSTER_PDEF_MULTIPLIER;
					_baseMDef *= ConfigNpcs.MONSTER_MDEF_MULTIPLIER;
					break;
				case "RaidBoss":
					_baseHpMax *= ConfigNpcs.RAIDBOSS_HP_MULTIPLIER;
					_baseMpMax *= ConfigNpcs.RAIDBOSS_MP_MULTIPLIER;
					_basePAtk *= ConfigNpcs.RAIDBOSS_PATK_MULTIPLIER;
					_baseMAtk *= ConfigNpcs.RAIDBOSS_MATK_MULTIPLIER;
					_basePDef *= ConfigNpcs.RAIDBOSS_PDEF_MULTIPLIER;
					_baseMDef *= ConfigNpcs.RAIDBOSS_MDEF_MULTIPLIER;
					break;
				case "GrandBoss":
					_baseHpMax *= ConfigNpcs.GRANDBOSS_HP_MULTIPLIER;
					_baseMpMax *= ConfigNpcs.GRANDBOSS_MP_MULTIPLIER;
					_basePAtk *= ConfigNpcs.GRANDBOSS_PATK_MULTIPLIER;
					_baseMAtk *= ConfigNpcs.GRANDBOSS_MATK_MULTIPLIER;
					_basePDef *= ConfigNpcs.GRANDBOSS_PDEF_MULTIPLIER;
					_baseMDef *= ConfigNpcs.GRANDBOSS_MDEF_MULTIPLIER;
					break;
			}
		}
