...
public class Agathion extends Folk
{
	...
	private void thinking()
	{
		if (_task != null)
		{
			...
			if (onlinePlayer != null)
			{
				...
				{
					if (AgathionState.get(onlinePlayer) != null)
					{
						
						AgathionState.delete(onlinePlayer, AgathionState.get(onlinePlayer));
						AgathionState.set(onlinePlayer, null);
						deleteMe();
					}
				}
	...
	private void heal()
	{
		List<? extends IAgathionSpec> agationList = AgathionHooks.get().getAgathionsByItemId(_itemId);
		...
		for (IAgathionSpec agation : agationList)
		{
