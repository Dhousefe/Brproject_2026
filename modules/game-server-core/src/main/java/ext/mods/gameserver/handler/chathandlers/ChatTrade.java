...
public class ChatTrade implements IChatHandler
{
	...
	public void handleChat(SayType type, Player player, String target, String text)
	{
		...
		if (ConfigProject.TRADE_CHAT.equalsIgnoreCase("global") || (ConfigProject.TRADE_CHAT.equalsIgnoreCase("gm") && player.isGM()))
		{
		...
		else if (ConfigProject.TRADE_CHAT.equalsIgnoreCase("on"))
