...
public class RatesManager implements IRatesManager {
    ...
    public RatesManager() {
        // Carregamento de rates.properties é feito sob demanda/background pelo DashboardPanel.
        // Evita IO bloqueante durante a criacao da janela Swing.
    }

    @Override
    public synchronized LinkedHashMap<String, Double> getAllRates() {
        return new LinkedHashMap<>(ratesCache);
    }

    @Override
    public synchronized void reloadRates() {
