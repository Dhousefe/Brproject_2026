...
public final class LoginClient extends MMOClient<MMOConnection<LoginClient>>
{
	...
	public static final class PendingChallenge
	{
		...
		public PendingChallenge(byte[] bytes, long issuedAt, int sessionId)
		{
			_bytes = bytes;
			_issuedAt = issuedAt;
		...
		{
			return (System.currentTimeMillis() - _issuedAt) > maxAgeMs;
		}
	}
	
	private volatile PendingChallenge _pendingChallenge;
	
	public synchronized void setPendingChallenge(PendingChallenge challenge)
	{
		_pendingChallenge = challenge;
	}
	
	public synchronized PendingChallenge consumePendingChallenge()
	{
		final PendingChallenge challenge = _pendingChallenge;
