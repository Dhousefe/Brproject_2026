...
object GameApiConfig {
    ...
    fun load() {
        ...
        siteWsPushHost = props.getProperty("SiteWsPushHost", "127.0.0.1").trim()
        siteWsPushPort = props.int("SiteWsPushPort", 8080).coerceIn(1, 65535)
        siteWsPushUrl = if (siteWsPushHost.isNotEmpty()) "http://$siteWsPushHost:$siteWsPushPort" else null
