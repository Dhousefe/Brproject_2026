...
public class EmailItemSender
{
	...
	{
		String targetName = EmailState.target(sender);
		...
		String durationOption = EmailState.duration(sender);
		...
		Map<Integer, Long> selectedItems = UiTempState.selectedItems(sender);
		...
		UiTempState.clearSelectedItems(sender);
		EmailState.setTarget(sender, null);
