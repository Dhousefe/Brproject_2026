...
/**
 * Runner executavel para disparar o microbenchmark JMH da IA e Movimentacao de Monstros.
 */
public final class MonsterAiBenchmarkRunner
{
    public static void main(String[] args) throws RunnerException
    {
        System.out.println("====================================================================");
        System.out.println("🚀 BrProject-2026 - Monster AI & Movement JMH Microbenchmark");
        System.out.println("Avaliacao: Melee Attack Range, Dynamic Formation Ring, Terrain Z Sampling");
        System.out.println("====================================================================");

        final Options opt = new OptionsBuilder()
            .include(MonsterAiMovementBenchmark.class.getSimpleName())
            .warmupIterations(1)
        ...
        System.out.println("\n====================================================================");
        System.out.println("📊 RELATORIO COMPARATIVO DE PERFORMANCE DA IA DE MONSTROS");
        System.out.println("====================================================================");
